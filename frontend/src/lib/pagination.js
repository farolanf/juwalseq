...
export const createPages = ({ currentPage, totalPages, leadCount }) => {
  ...
  pages.push({ title: 'next', num: next, disabled: !(currentPage >= 1 && currentPage < last) })
  ...
  currentPage >= 1 && pages.push({ title: currentPage, num: currentPage, disabled: true, active: true })
