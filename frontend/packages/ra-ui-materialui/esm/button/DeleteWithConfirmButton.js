...
var DeleteWithConfirmButton = /** @class */ (function (_super) {
    ...
    DeleteWithConfirmButton.prototype.render = function () {
        var _a = this.props, _b = _a.classes, classes = _b === void 0 ? {} : _b, className = _a.className, icon = _a.icon, _c = _a.label, label = _c === void 0 ? 'ra.action.delete' : _c, onClick = _a.onClick, record = _a.record, resource = _a.resource, rest = __rest(_a, ["classes", "className", "icon", "label", "onClick", "record", "resource"]);
